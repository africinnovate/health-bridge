...
use health_bridge::schema::{
    appointments, blood_requests, hospitals, patients, specialist_availabilities, specialists,
    specialties, users,
};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let patient_user = NewUser {
        ...
        address: Some("123 Patient St, City, State, ZIP"),
        image_url: None,
    ...
    let patient_medical = MedicalInfo {
        ...
        medications: Some("None"),
        existing_conditions: Some("None"),
    ...
    let donor_user = NewUser {
        ...
        address: Some("123 Donor St, City, State, ZIP"),
        image_url: None,
    ...
    let hospital_user = NewUser {
        ...
        gender: None,
        address: Some("123 Hospital St, City, State, ZIP"),
        image_url: None,
        dob: None,
        password_hash: &password_hash,
        role: Role::Hospital,
    ...
    let admin_user = NewUser {
        ...
        gender: Some(Gender::Male),
        address: Some("123 Admin St, City, State, ZIP"),
        image_url: None,
    ...
    let specialist_user = NewUser {
        ...
        gender: Some(Gender::Female),
        address: Some("123 Specialist St, City, State, ZIP"),
        image_url: None,
    ...
    let blood_request_1 = NewBloodRequest {
        ...
        timeline_status: Some(
            health_bridge::utils::enums::TimelineTypeEnum::DonationAppointmentScheduled,
        ),
