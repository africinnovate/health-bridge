...
#[openapi(
    paths(
        ...
        appointments::apply_points_preview,
    ...
    components(
        schemas(
            ...
            referrals::PointCalculatorResponse,
            appointments::ApplyPointsPayload,
            appointments::ApplyPointsResponse,
